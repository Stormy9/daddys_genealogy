...
using HolmanBerg.Models;

namespace HolmanBerg.Controllers
{
    [Authorize]
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> VerifyCode(VerifyCodeViewModel model)
        {
            ...
            // If a user enters incorrect codes for a specified amount of time  
            // then the user accountwill be locked out for a specified amount of time. 
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // For more info on how to enable account confirmation and password
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                // For more infor on how to enable account confirmation and password 
                // reset please visit https://go.microsoft.com/fwlink/?LinkID=320771
                //
                // Send an email with this link
